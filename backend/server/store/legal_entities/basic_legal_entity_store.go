...
type BasicLegalEntityStore struct {
	table *store.ResourceTable
}

func NewBasicLegalEntityStore(db *store.DB, logFactory logger.LogFactory) *BasicLegalEntityStore {
	return &BasicLegalEntityStore{
...
func (d *BasicLegalEntityStore) Create(ctx context.Context, txOrNil *store.Tx, legalEntityData *models.LegalEntityData) (*models.LegalEntity, error) {
...
func (d *BasicLegalEntityStore) Read(ctx context.Context, txOrNil *store.Tx, id models.LegalEntityID) (*models.LegalEntity, error) {
	legalEntity := &models.LegalEntity{}
...
// Returns models.ErrNotFound if the legal entity does not exist.
func (d *BasicLegalEntityStore) ReadByName(ctx context.Context, txOrNil *store.Tx, name models.ResourceName) (*models.LegalEntity, error) {
	legalEntity := &models.LegalEntity{}
...
// Returns models.ErrNotFound if the legal entity does not exist.
func (d *BasicLegalEntityStore) ReadByExternalID(ctx context.Context, txOrNil *store.Tx, externalID models.ExternalResourceID) (*models.LegalEntity, error) {
	legalEntity := &models.LegalEntity{}
...
func (d *BasicLegalEntityStore) FindOrCreate(
	ctx context.Context,
	txOrNil *store.Tx,
...
func (d *BasicLegalEntityStore) Update(ctx context.Context, txOrNil *store.Tx, legalEntity *models.LegalEntity) error {
...
func (d *BasicLegalEntityStore) Upsert(ctx context.Context, txOrNil *store.Tx, legalEntityData *models.LegalEntityData) (*models.LegalEntity, bool, bool, error) {
	if legalEntityData.ExternalID == nil {
...
func (d *BasicLegalEntityStore) ListParentLegalEntities(
	ctx context.Context,
	txOrNil *store.Tx,
...
func (d *BasicLegalEntityStore) ListMemberLegalEntities(
	ctx context.Context,
	txOrNil *store.Tx,
...
func (d *BasicLegalEntityStore) ListAllLegalEntities(ctx context.Context, txOrNil *store.Tx, pagination models.Pagination) ([]*models.LegalEntity, *models.Cursor, error) {
