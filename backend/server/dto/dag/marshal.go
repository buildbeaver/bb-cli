...
type marshalGraph struct {
	...
	// ListForStep of graph vertices, sorted by ID.
	Vertices []*marshalVertex `json:",omitempty"`

	// ListForStep of edges, sorted by Source ID.
...
// vertices is a sort.Interface implementation for sorting vertices by ResourceID
...
type marshalEdge struct {
	...
	// Source and Target Vertices by ResourceID
	Source string
	Target string
...
// edges is a sort.Interface implementation for sorting edges by Source ResourceID
...
// Attempt to return a unique ResourceID for any vertex.
