...
// isContainerNameForJob returns true if the specified string is a valid container name for a docker container
// created by this program to run a service.
...
// isNetworkName returns true if the specified string is a valid network name for a docker network created by this program.
