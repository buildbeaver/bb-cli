...
// CleanUpContainers looks for existing containers and removes them.
...
// CleanUpNetworks looks for existing networks and removes them.
...
// containerIsOurs returns true if the specified container was created by this program.
// Can be used to identify which containers to clean up and which to leave alone.
func containerIsOurs(container types.Container) bool {
...
// networkIsOurs returns true if the specified network was created by this program.
// Can be used to identify which networks to clean up and which to leave alone.
func networkIsOurs(network types.NetworkResource) bool {
